...
///************************************
//    Other Things to Know about Parse() (This may be incorrect or out of context, since this problem only exists when yousing JSONParser())
//************************************/
//    // Understanding parsing order: After parsing an object into JSON, the order of the objects 
//    // will be back words. However, this should not be any issue since the values within the 
//    // object will be referenced by their key and not traversed like an array. In essence, 
//    // order should not matter. You can see that the order switched when you expand and observe the 
//    // newly parsed object in the console.
//    var myJsonObject = JSON.parse('{"Name": "Dan", "Age": 27, "Address": {"Street": "123 Ave.", "City" : "Rexburg", "State": "Idaho", "Zip" : "83340"}}');
